...
public class ModItems {
    ...
    public static final DeferredRegister<DataComponentType<?>> COMPONENTS = DeferredRegister.create(Registries.DATA_COMPONENT_TYPE, RandoWand.MODID);
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<List<net.minecraft.world.item.ItemStack>>> WAND_PALETTE =
            COMPONENTS.register("wand_palette", () -> DataComponentType.<List<net.minecraft.world.item.ItemStack>>builder()
                    ...
                    .networkSynchronized(net.minecraft.network.codec.StreamCodec.composite(
                            net.minecraft.world.item.ItemStack.STREAM_CODEC.apply(net.minecraft.network.codec.ByteBufCodecs.list()), i -> i, i -> i))
                    .build());

    public static final DeferredHolder<Item, Item> RANDOM_WAND = ITEMS.register("randowand",
